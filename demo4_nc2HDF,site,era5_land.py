""" Read the raw ERA5 files (*.nc) and save the data for specific sites into an HDF5 file, 
    suitable for processing ERA5 Land data """
...
# directory of raw ERA5 Land data, the directory structure is as follows:
# 
...
dir_nc = Path(__file__).parent / 'ERA5' / 'reanalysis-era5-land'
...
if __name__ == '__main__':
    ...
    # read ERA5 data
    for short_name, long_name in dict_var_land.items():
